...
function Card({
  ...
  return (
    <Link
      ...
      <div
        className=" relative mr-auto h-[280px] w-full  bg-[var(--tg-theme-secondary-bg-color)] bg-cover bg-no-repeat "
        style={{
      ...
      <div className="flex h-full w-full flex-col items-start justify-between gap-3 p-2">
        <div className="mb-1 mr-auto h-5 w-full select-none text-left ">
          {title}
        </div>
