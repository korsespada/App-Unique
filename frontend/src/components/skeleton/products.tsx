  ...
  return (
    <div
      ...
      <div className="flex w-2/3 flex-col items-center justify-between p-2">
        <div className="mb-1 mr-auto h-5 w-1/3 select-none rounded-lg  bg-[var(--tg-theme-secondary-bg-color)] text-left " />
        <p className="mb-1 mr-auto h-5 w-full select-none rounded-lg bg-[var(--tg-theme-secondary-bg-color)] text-left text-gray-500 " />
      ...
      <div className=" mr-auto h-full w-1/3  bg-[var(--tg-theme-secondary-bg-color)]" />
    </div>
  );
}
