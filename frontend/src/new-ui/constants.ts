...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Иконический силуэт в расцветке Slate. Сочетание комфорта Primeknit и амортизации Boost.",
  ...
  },
  {
    ...
    description:
      "Элегантная сумка через плечо с фирменной застежкой в виде головы змеи.",
